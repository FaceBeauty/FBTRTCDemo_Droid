...
public class FBBeautyBodyFragment extends FBBaseFragment {
  ...
  private int currentPosition = FBSelectedPosition.POSITION_BODY;
  ...
  protected void initView(View view, Bundle savedInstanceState) {
    ...
    FBState.currentViewState = FBViewState.BEAUTY_BODY;
...
//      refreshTabs();
  ...
  public void onDestroyView() {
    super.onDestroyView();
      FBEffect.shareInstance().setBodyBeauty(0, 0);
      FBEffect.shareInstance().setBodyBeauty(1, 0);
      FBEffect.shareInstance().setBodyBeauty(2, 0);
      FBEffect.shareInstance().setBodyBeauty(3, 0);
      FBEffect.shareInstance().setBodyBeauty(4, 0);
      FBEffect.shareInstance().setBodyBeauty(5, 0);
      FBEffect.shareInstance().setBodyBeauty(6, 0);
      FBEffect.shareInstance().setBodyBeauty(7, 0);
  }
}