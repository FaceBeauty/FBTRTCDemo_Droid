...
import com.nimo.fb_effect.adapter.BeautyBodyItemViewBinder;
...
public class BeautyBodyFragment extends FBBaseLazyFragment {

    private final MultiTypeAdapter adapter = new MultiTypeAdapter();

    private final List<BeautyBody> mData;
    ...
    {
        mData = Arrays.asList(BeautyBody.values());
    }

    @Override protected int getLayoutId() {
        return R.layout.beauty_body;
    }
    ...
    @Override protected void initView(
        ...
        RecyclerView rvBeautyBody = findViewById(R.id.rv_beautyBody);
        rvBeautyBody.setHasFixedSize(true);
        ...
        adapter.register(BeautyBody.class, new BeautyBodyItemViewBinder());

        rvBeautyBody.addItemDecoration(new
                MyItemDecoration(5)
        );

        rvBeautyBody.setAdapter(adapter);

        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View view) {
                resetDialog.show(getChildFragmentManager(), "beauty_body");
            }
        });
    ...
    public void changedPoint(Object o) {
        adapter.notifyItemChanged(FBUICacheUtils.beautyBodyPosition());
    }
    ...
    public void syncReset(String message) {
        ...
        btnReset.setEnabled(FBUICacheUtils.beautyBodyResetEnable());
        ivReset.setEnabled(FBUICacheUtils.beautyBodyResetEnable());
        tvReset.setEnabled(FBUICacheUtils.beautyBodyResetEnable());
